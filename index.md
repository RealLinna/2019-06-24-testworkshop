...
venue: "TIB Hannover"        # brief name of host site without address (e.g., "Euphoric State University")
...
language: "German"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
